package examples.array;// JAVA Code For Chocolate Distribution
// Problem
import java.util.*;
...
class Chocolates {
    ...
    static int findMinDiff(int arr[], int n, int m)
    {
        ...
        // Find the Sub Array of size m such that difference between last (maximum in case of
        // sorted) and first (minimum in case of sorted) elements of Sub Array is minimum.
